...
const u1 = defineUnit(GRADE_ID, 'u1', '분수의 덧셈과 뺄셈', [
  차시('1~2차시 (진분수)+(진분수) 계산하기', { grid: 'practice', count: 15 }, [
    학습지('분모 같은 진분수의 덧셈 (합이 1 미만)', genG42U1AddLt1, {
      id: 'u1_main_add',
      prereqs: [ext('[3-2] 분수')],
    }),
    학습지('분모 같은 진분수의 덧셈 (합이 1 이상)', genG42U1AddGe1, {
      id: 'u1_main_add_ge1',
      prereqs: [sheetRef('u1_main_add')],
    }),
  ]),
  차시('3차시 (진분수)-(진분수) 계산하기', { grid: 'practice', count: 15 }, [
    학습지('분모 같은 진분수의 뺄셈', genG42U1Sub, {
      id: 'u1_main_sub',
      prereqs: [sheetRef('u1_main_add')],
    }),
  ]),
  차시('4차시 1 - (진분수)', { grid: 'practice', count: 15 }, [
    학습지('1 − (진분수)', genG42U11MinusFrac, {
      id: 'u1_main_one_minus_frac',
      prereqs: [sheetRef('u1_main_sub')],
    }),
  ]),
  차시('5차시 (자연수) - (진분수)', { grid: 'practice', count: 15 }, [
    학습지('(자연수) − (진분수)', genG42U1IntMinusFrac, {
  ...
  차시('7차시 분모 같은 (대분수)+(대분수), 받아올림 있음', { grid: 'practice', count: 15 }, [
    학습지('대분수의 덧셈 (받아올림 있음)', genG42U1MixedAddCarry, {
  ...
  차시('9차시 (자연수) - (대분수)', { grid: 'practice', count: 15 }, [
    학습지('(자연수) − (대분수)', genG42U1IntMinusMixed, {
      id: 'u1_main_int_minus_mixed',
      prereqs: [sheetRef('u1_main_mixed_sub'), sheetRef('u1_main_int_minus_frac')],
    }),
  ]),
  차시('10차시 분모 같은 (대분수)-(대분수), 받아내림 있음', { grid: 'practice', count: 15 }, [
    학습지('대분수의 뺄셈 (받아내림 있음)', genG42U1MixedSubBorrow, {
