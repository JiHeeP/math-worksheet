...
import {
  ...
  genG42U11MinusFrac, genG42U1IntMinusFrac, genG42U1MixedSubFrac,
...
const u1 = defineUnit(GRADE_ID, 'u1', '분수의 덧셈과 뺄셈', [
  ...
  차시('8차시 분모 같은 (대분수)-(대분수), 받아내림 없음', { grid: 'practice', count: 15, ...FRAC_STAGE_4 }, [
    학습지('대분수의 뺄셈 (받아내림 없음)', genG42U1MixedSubNoBorrow, {
      id: 'u1_main_mixed_sub',
      prereqs: [sheetRef('u1_main_sub')],
    }),
  ]),
  차시('9차시 (자연수) − (대분수) (받아내림)', FRAC_STAGE_4, [
  ...
  차시('10차시 분모 같은 (대분수)-(대분수), 받아내림 있음', FRAC_STAGE_4, [
